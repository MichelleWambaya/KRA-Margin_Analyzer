...
const App: React.FC = () => {
    ...
    <div className="space-y-4">
      <header className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <ThemeToggle />
          <p className="max-w-[9rem] text-right text-[11px] text-neutral-700 dark:text-neutral-400">
      ...
      <section className="rounded-2xl border border-neutral-300 bg-neutral-100 p-3 shadow-sm dark:border-white/10 dark:bg-neutral-900/80">
        <div className="flex items-center justify-between gap-2">
          <div>
            <p className="text-xs font-semibold uppercase tracking-wide text-neutral-800 dark:text-neutral-300">
              Recent Transactions
            </p>
            <p className="text-[11px] text-neutral-700 dark:text-neutral-400">
              Quick snapshot of the last activity.
            </p>
          </div>
          <span className="rounded-full bg-emerald-600/20 px-2 py-0.5 text-[10px] font-semibold text-emerald-700 dark:text-emerald-300">
            Data‑light
          </span>
        </div>
        <ul className="mt-2 space-y-1.5 text-xs">
          {expenses
            ...
            .map((expense) => (
              <li
                key={expense.id}
                className="flex items-center justify-between rounded-lg bg-neutral-200 px-2 py-1 dark:bg-neutral-800/80"
              >
                <span className="truncate text-neutral-900 dark:text-neutral-200">
                  {expense.label}
                </span>
                <span
                  className={
  ...
  const renderExpensesTab = () => (
    <div className="space-y-4">
      ...
      <section className="space-y-3 rounded-2xl border border-neutral-300 bg-neutral-100 p-3 dark:border-white/10 dark:bg-neutral-900/80">
        <div className="space-y-2">
          <label className="block text-xs font-medium text-neutral-800 dark:text-neutral-300">
            Expense label
          </label>
          <input
            className="w-full rounded-lg border border-neutral-400 bg-white px-3 py-2 text-sm text-neutral-900 outline-none ring-emerald-500 focus:border-emerald-500 focus:ring-1 dark:border-neutral-700 dark:bg-neutral-950 dark:text-white"
        ...
        <div className="flex gap-2">
          <div className="flex-1">
            ...
            <input
              className="mt-1 w-full rounded-lg border border-neutral-400 bg-white px-3 py-2 text-sm text-neutral-900 outline-none ring-emerald-500 focus:border-emerald-500 focus:ring-1 dark:border-neutral-700 dark:bg-neutral-950 dark:text-white"
              type="number"
              min={0}
          ...
          <button
            ...
            className={[
              ...
              newExpenseType === "etims"
                ...
                : "border-neutral-400 bg-neutral-200 text-neutral-800 dark:border-neutral-700 dark:bg-neutral-900 dark:text-neutral-300",
            ].join(" ")}
          >
            eTIMS Compliant
          </button>
      ...
      <section className="space-y-2 rounded-2xl border border-neutral-300 bg-neutral-100 p-3 text-xs dark:border-white/10 dark:bg-neutral-900/80">
        <div className="flex items-center justify-between">
          <p className="font-semibold text-neutral-900 dark:text-neutral-200">All Expenses</p>
        ...
        <ul className="mt-1 space-y-1.5">
          {expenses.map((expense) => (
            <li
              key={expense.id}
              className="flex items-center justify-between rounded-lg bg-neutral-200 px-2 py-1.5 dark:bg-neutral-800/80"
            >
              <div>
  ...
  const renderTaxTab = () => (
    <div className="space-y-4">
      ...
      <section className="space-y-3 rounded-2xl border border-red-400 bg-red-50 p-3 text-xs dark:border-red-700/60 dark:bg-red-950/40">
        ...
        <div className="flex gap-2">
          <input
            className="w-full flex-1 rounded-lg border border-red-400 bg-white px-3 py-2 text-sm text-neutral-900 outline-none ring-red-500 focus:border-red-500 focus:ring-1 dark:border-red-600/60 dark:bg-neutral-950 dark:text-white"
            type="number"
            min={0}
      ...
      <section className="space-y-2 rounded-2xl border border-emerald-400 bg-emerald-50 p-3 text-xs dark:border-emerald-600/60 dark:bg-emerald-950/40">
  ...
  const renderSettingsTab = () => (
    <div className="space-y-4">
      ...
      <section className="space-y-3 rounded-2xl border border-neutral-300 bg-neutral-100 p-3 text-xs dark:border-white/10 dark:bg-neutral-900/80">
        <div className="flex items-center justify-between">
          <span className="text-neutral-800 dark:text-neutral-200">Daily Gross Sales</span>
          <input
            className="w-28 rounded-lg border border-neutral-400 bg-white px-2 py-1 text-right text-xs text-neutral-900 outline-none ring-emerald-500 focus:border-emerald-500 focus:ring-1 dark:border-neutral-700 dark:bg-neutral-950 dark:text-white"
            type="number"
            min={0}
            value={grossSales}
      ...
      <section className="space-y-3 rounded-2xl border border-neutral-300 bg-neutral-100 p-3 text-xs dark:border-white/10 dark:bg-neutral-900/80">
        <p className="text-[11px] font-semibold uppercase tracking-wide text-neutral-800 dark:text-neutral-400">
          About
        </p>
        <p className="text-neutral-900 dark:text-neutral-200">
  ...
  const renderQuickBill = () => (
    <section className="mt-4 space-y-2 rounded-2xl border border-neutral-300 bg-neutral-100 p-3 text-xs dark:border-white/10 dark:bg-neutral-900/90">
      <div className="flex items-center justify-between gap-2">
        <div>
          <p className="text-[11px] font-semibold uppercase tracking-wide text-neutral-800 dark:text-neutral-300">
      ...
      <div className="mt-2 flex gap-2">
        <input
          className="w-full max-w-[9rem] rounded-lg border border-neutral-400 bg-white px-2 py-1.5 text-xs text-neutral-900 outline-none ring-emerald-500 focus:border-emerald-500 focus:ring-1 dark:border-neutral-700 dark:bg-neutral-950 dark:text-white"
          placeholder="07xx..."
          value={mpesaPhone}
          onChange={(e) => setMpesaPhone(e.target.value)}
        />
        <input
          className="w-full max-w-[6rem] rounded-lg border border-neutral-400 bg-white px-2 py-1.5 text-xs text-neutral-900 outline-none ring-emerald-500 focus:border-emerald-500 focus:ring-1 dark:border-neutral-700 dark:bg-neutral-950 dark:text-white"
          type="number"
          min={0}
          value={mpesaAmount}
        ...
        <button
          ...
          className="flex-1 rounded-full bg-emerald-600 px-3 py-1.5 text-xs font-semibold text-white shadow-md shadow-emerald-800/50 disabled:cursor-not-allowed disabled:bg-neutral-400 dark:disabled:bg-neutral-700"
        >
      ...
      {mpesaStatus !== "idle" && (
        <div className="mt-2 text-[11px]">
          ...
          {(mpesaStatus === "success" || mpesaStatus === "failed") && (
            <button
              type="button"
              className="mt-1 text-[11px] font-medium text-emerald-700 underline underline-offset-2 dark:text-emerald-400"
              onClick={resetMpesa}
            >
              Clear
            </button>
